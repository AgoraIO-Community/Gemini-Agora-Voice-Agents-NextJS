  ...
  return (
    <div className="relative flex-shrink-0">
      ...
      <div
        ...
        className={`fixed top-16 left-1/2 z-50 w-[min(92vw,22rem)] -translate-x-1/2 rounded-md border border-border bg-card/95 p-3 space-y-2 shadow-lg backdrop-blur-sm transition-opacity md:absolute md:left-auto md:right-0 md:top-full md:mt-3 md:w-[24rem] md:translate-x-0 md:translate-y-0 ${
