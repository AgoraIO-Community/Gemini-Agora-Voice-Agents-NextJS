...
- Missing `NEXT_PUBLIC_AGORA_APP_ID`/`NEXT_AGORA_APP_CERTIFICATE` yields hard 500s on token/invite/stop routes; missing `NEXT_GOOGLE_API_KEY` fails the invite route.
